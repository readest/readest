...
describe('useParagraphMode', () => {
  ...
  it('initializes from the renderer primary section instead of the first loaded section', async () => {
  ...
  it('moves to the next chapter when the active section changes across a chapter boundary', async () => {
    const previousChapterDoc = createDoc('<p>Old chapter ending</p>');
    const nextChapterDoc = createDoc('<h1>Chapter 2</h1><p>First paragraph</p>');
