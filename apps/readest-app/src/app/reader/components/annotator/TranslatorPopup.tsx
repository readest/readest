  ...
  return (
    <div>
      <Popup
        ...
        maxHeight={720}
        position={position}
        className='grid h-full select-text grid-rows-[1fr,auto,1fr]'
        onDismiss={onDismiss}
      >
        ...
        <div className='flex items-center justify-between gap-2 border-t border-base-200/80 px-4 py-2 bg-base-200/40 rounded-b-xl shrink-0'>
