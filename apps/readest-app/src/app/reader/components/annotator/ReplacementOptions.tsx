...
const ReplacementOptions: React.FC<ReplacementOptionsProps> = ({
  ...
  const getScopeLabel = (scope: 'once' | 'book' | 'library' | null) => {
    switch (scope) {
      case 'once': return 'this instance';
      case 'book': return 'all instances in this book';
      case 'library': return 'all instances in your library';
      default: return '';
    }
  };
      ...
      >
        ...
        <div className="flex gap-2 mt-2">
          <button
            ...
            className="flex-1 rounded-md bg-gray-600 px-3 py-2 text-sm text-white hover:bg-gray-500 transition-colors"
          >
            Back
          </button>
          <button
            onClick={handleConfirm}
            className="flex-1 rounded-md bg-green-600 px-3 py-2 text-sm text-white hover:bg-green-500 transition-colors"
          >
            Confirm
          </button>
        </div>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-2 rounded-md bg-gray-600 px-3 py-2 text-sm text-white hover:bg-gray-500 transition-colors"
      >
        Cancel
      </button>
    </div>
