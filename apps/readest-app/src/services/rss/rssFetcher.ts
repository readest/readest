import { RSSFeed, RSSItem, RSSEnclosure } from '@/types/rss';
import {
  getAPIBaseUrl,
  getNodeAPIBaseUrl,
  isTauriAppPlatform,
...
const NODE_RSS_PROXY_URL = `${getNodeAPIBaseUrl()}/rss/proxy`;
 ...
 */
export const extractPDFUrl = (item: RSSItem): string | null => {
...
const parseAtomItem = (entryEl: Element): RSSItem => {
  ...
  // Extract DOI from content or description
