...
- [#6088 `[xml|lang]`/`:lang()` dead on xml:lang](xml-lang-namespace-selector-6088.md) PR #6090 OPEN; `xml` prefix never declared; body{color} loss BY DESIGN; body{line-height:unset} now gated by Use Book Layout
