...
- [iOS TTS support mail + landing docs recipe](landing-docs-support-reply-tts-ios.md) Edge is the silent default; voice ONLY in the player; landing PR #35 MERGED; reply SENT 2026-09-06
...
- [#6088 `[xml|lang]`/`:lang()` dead on xml:lang](xml-lang-namespace-selector-6088.md) MERGED #6090 (04379b8f8); `xml` prefix never declared; body{color} loss BY DESIGN; body{line-height:unset} now gated by Use Book Layout
...
- [Merge one account into another](account-merge-recipe.md) `scripts/db/merge-accounts.mjs` MERGED #6121 (64d594380); 2026-09-07 ticket APPLIED, reply pending; files = R2 copy + key rewrite; stamp updated_at on configs/notes/stats
