...
- Suite flake: `openFixtureBook`/`longPressWord` occasionally time out right after install/force-stop; `adb shell am force-stop com.biblophile.readest`, wait ~3s, re-run.
